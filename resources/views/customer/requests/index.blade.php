<x-customer-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <a href="{{ route('customer.requests.create') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
                {{ __('Nový požadavek') }}
            </a>
        </div>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <!-- Filtry -->
                    <div class="mb-6">
                        <form method="GET" action="{{ route('customer.requests.index') }}" class="flex flex-wrap gap-4">
                            <div>
                            ...
                            <div class="flex items-end">
                                ...
                                <a href="{{ route('customer.requests.index') }}" class="ml-2 inline-flex items-center px-4 py-2 bg-gray-200 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-300">
                                    {{ __('Reset') }}
                                </a>
                            </div>
                        </form>
