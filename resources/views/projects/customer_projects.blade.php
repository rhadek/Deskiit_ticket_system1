    ...
    <x-slot name="header">
        <div class="flex justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Projekty firmy: ') }} {{ $customer->name }}
            </h2>
            <div>
                <a href="{{ route('projects.create', ['id_customer' => $customer->id]) }}" class="inline-flex items-center px-4 py-2 bg-green-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-green-700 mr-2">
                    {{ __('Nový projekt') }}
                </a>
